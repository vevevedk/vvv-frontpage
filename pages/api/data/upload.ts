      ...
      try {
        if (dataType === 'campaign_performance_daily') {
          ...
          const mappedRecord = {
            ...
            conversion_value: row['Conv. value'],
            budget_name: row['Budget name'],
            budget: row['Budget'],
            budget_type: row['Budget type'],
            recommended_budget: row['Recommended budget'],
            est_add_interactions_per_week: row['Est. add. interactions/wk (rec. budget)'],
            est_add_cost_per_week: row['Est. add. cost/wk (rec. budget)'],
            bid_strategy: row['Bid strategy'],
            bid_strategy_type: row['Bid strategy type'],
            target_cpa: row['Target CPA'],
            target_roas: row['Target ROAS'],
